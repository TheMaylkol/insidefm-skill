...
const name = "InsideFM" // Station Name
const url = "https://live.insidefm.cl/hls/insidefm/live.m3u8" // Stream URL

const images = {
  logo: "https://insidefm.cl/images/logo.png", // 512x512, image name, added on alexa skill
  background: "https://insidefm.cl/images/image.png" // 1920x1080 - image name, added on alexa skill
}
...
const STREAMS = [
    {
        ...
        "metadata": {
            "title": name,
            "subtitle": "Activate con la Musica!",
            "art": {
                "sources": [
                    {
